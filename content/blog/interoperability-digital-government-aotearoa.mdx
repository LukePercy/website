...
This is not really a new ambition.
...
Especially if the goal is not just to digitise existing complexity, but to build a **digital public environment** that is more coherent, resilient, and useful to the people who rely on it.

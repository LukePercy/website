...
- [About GitHub Copilot usage-based billing](https://docs.github.com/en/copilot/managing-copilot/managing-copilot-as-an-individual-subscriber/managing-your-copilot-plan/about-github-copilot-usage-based-billing) — GitHub Docs
- [Customising GitHub Copilot in your organisation](https://docs.github.com/en/copilot/customizing-copilot/customizing-github-copilot-in-your-organization) — GitHub Docs
- [Caveman](https://github.com/unternet-co/caveman) — token reduction via terse AI responses

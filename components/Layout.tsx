...
function mixColor(from: string, to: string, amount: number): string {
  ...
  const fromRed = parseInt(fromColor.slice(0, 2), 16);
  const fromGreen = parseInt(fromColor.slice(2, 4), 16);
  const fromBlue = parseInt(fromColor.slice(4, 6), 16);
  const toRed = parseInt(toColor.slice(0, 2), 16);
  const toGreen = parseInt(toColor.slice(2, 4), 16);
  const toBlue = parseInt(toColor.slice(4, 6), 16);
